...
def getKey():
    ...
    id = "".join(uuidd).replace("_","").replace("360","Rahi").replace("u","9").replace("a","A")
...
try:
    prox= requests.get('https://raw.githubusercontent.com/Aizazrahi12/F_7/main/F7.txt').text
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('[+] IF you are new user use auto pass');linex();print('[1] Crack with auto pass \n[2] crack with choice pass ');linex()
                                ppp=input('[+] Choose: ')
                                if ppp in ['1','01']:
                                ...
                                exit(' THANKS FOR USE Rahi TOOL ')
                        else:
                                exit(' Select valid option .')                
                else:
                        print("\033[1;32m Rahi SERVER IS OFF")
...
def za():
    ...
    if myid in str(body):
        ...
        url_wa = "https://api.whatsapp.com/send?phone=+923495147094&text="
        name = input("[+] Type your name ")
        tks = ("Hi Rahi Sir I WANT TO BUY YOUR PAID TOOL V 7.2 PLEASE ACCEPT MY KEY FOR PREMIUM \nMy name : "+name+" \nMy Key : "+myid)
        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
        print("\033[1;37m run again python Rahi.py")
